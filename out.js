...
(function dartProgram() {
  ...
  P = {Codec: function Codec() {
    ...
    Process_runSync: function(executable, $arguments) {
      throw H.wrapException(P.UnsupportedError$("Process.runSync"));
    },
  ...
  U = {
    main: function($arguments) {
      var argument,
        _s16_ = "/opt/lampp/lampp",
        t1 = type$.JSArray_String,
        commands = H.setRuntimeTypeInfo(["start", "stop"], t1);
      if ($arguments.length === 0) {
        P.print("No input argument, toggling current state...");
        P.Process_runSync("sudo", H.setRuntimeTypeInfo([_s16_, commands[0] + "mysql"], t1));
      } else {
        argument = C.JSArray_methods.get$first($arguments);
        if (C.JSArray_methods.contains$1(commands, argument)) {
          P.print("Executing command...");
          P.Process_runSync("sudo", H.setRuntimeTypeInfo([_s16_, argument + "mysql"], t1));
        } else
          P.print("Invalid Command");
      }
    }
  };
  var holders = [C, H, J, P, U];
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Error, H.Closure, H.Rti, H._FunctionParameters, P.Codec, P.Null, P.StringBuffer]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JSArray, J.JSNumber, J.JSString]);
    _inherit(J.JSUnmodifiableArray, J.JSArray);
    _inheritMany(J.JSNumber, [J.JSInt, J.JSNumNotInt]);
    _inheritMany(P.Error, [H.LateError, H.RuntimeError, H._Error, P.AssertionError, P.NullThrownError, P.ArgumentError, P.UnsupportedError, P.StateError, P.ConcurrentModificationError, P.CyclicInitializationError]);
    _inherit(H.TearOffClosure, H.Closure);
    _inheritMany(H.TearOffClosure, [H.StaticClosure, H.BoundClosure]);
    _inherit(H._TypeError, H._Error);
    _inherit(P.Encoding, P.Codec);
    _inheritMany(P.ArgumentError, [P.RangeError, P.IndexError]);
    _inherit(P.SystemEncoding, P.Encoding);
  })();
  var init = {
  ...
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JSBool":{"bool":[]},"JSArray":{"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[]},"int":{"num":[]},"List":{"Iterable":["1"]}}'));
  H._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"Codec":2}'));
  0;
